...
public class App {
    ...
    public static int numberOfInstances = 1;  //Important: Do not exceed 7
    ...
    /**
     * The class activate and config the AWS services
     * The logic as at different class
     */
    public static void main(String[]args){

         // initiate clients: aws, ec2, s3, emr
        ...
        HadoopJarStepConfig step1 = new HadoopJarStepConfig()
                .withJar(String.format("%s/jars/WordCount.jar" , s3Path)) //Specifies the location of the JAR file that contains the job logic.
